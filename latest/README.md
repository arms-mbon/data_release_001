...
These are the data files associated with the first ARMS-MBON dataset submitted to EurOBIS ([DOI](https://doi.org/10.14284/620)): species identifications, sampling even metadata, image metadata for the COI marker gene for the events between 2018 and 2020 (all events that started in 2018 and 2019). This includes: 
